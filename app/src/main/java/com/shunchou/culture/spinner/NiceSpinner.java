package com.shunchou.culture.spinner;
...
public class NiceSpinner extends TextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int defaultPadding = resources.getDimensionPixelSize(R.dimen.one_and_a_half_grid_unitpadding);
        ...
        setTextColor(getResources().getColor(R.color.colorselect));
        ...
        if (!isArrowHide) {
           // Drawable basicDrawable = ContextCompat.getDrawable(context, R.drawable.arrow);
            Drawable basicDrawable = ContextCompat.getDrawable(context, R.mipmap.arrowdownicon);
